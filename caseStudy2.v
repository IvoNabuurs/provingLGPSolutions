...
[[85, "Oscar", "September 1st", "senator"],
 [100, "Gerald", "September 29th", "lawyer"],
 [115, "Timothy", "October 13th", "father"],
 [130, "Shannon", "September 22nd", "brother"]].
...
(* Case study 2. *)
Theorem caseStudy2 : 
preconditions /\ directLink "Timothy" "October 13th" /\ directLink "father" "October 13th" /\ 
noLink "lawyer" "September 1st" /\ allDifferent [100, "Oscar", "brother"] /\ 
comparison "Timothy" "September 22nd" 0 before /\ 
comparison "senator" "Gerald" 0 (beforeFixed 15) /\ 
allDifferent ["Oscar", 115, "lawyer"].
Proof.
Time autoProve.
Qed.
