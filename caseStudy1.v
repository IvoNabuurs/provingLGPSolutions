...
[[1, "Blue", "Brazilian", "Fishes", "Football"],
 [2, "Green", "American", "Cats", "Baseball"],
 [3, "Red", "German", "Dogs", "Basketball"]].
...
(* Case study 1. *)
Theorem caseStudy1 :  
preconditions /\ noLink "Brazilian" 2 /\ directLink "Dogs" "Basketball" /\ 
(comparison "Football" "Red" 0 (distance 2) /\ directLink "Red" 3) /\ 
comparison "Fishes" "Cats" 0 (beforeFixed 1) /\ comparison "Dogs" "Green" 0 (afterFixed 1) /\
directLink "German" 3.
Proof.
Time autoProve.
Qed.
