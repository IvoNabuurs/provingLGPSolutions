...
[["Morning", "Chengdu", "Plane"],
 ["Afternoon", "Helsinki", "Bus"],
 ["Evening", "Valparaiso", "Metro"]].
...
(* Case study 5. *)
Theorem caseStudy5 : 
preconditions /\ (directLink "Valparaiso" "Morning" \/ directLink "Helsinki" "Bus") /\ 
(noLink "Valparaiso" "Afternoon" \/ directLink "Chengdu" "Metro") /\
(noLink "Chengdu" "Metro" \/ directLink "Valparaiso" "Afternoon") /\ 
noLink "Helsinki" "Plane" /\ either "Metro" "Chengdu" "Valparaiso" /\ 
directLink "Plane" "Morning" /\ 
(noLink "Valparaiso" "Evening" \/ directLink "Helsinki" "Afternoon").
Proof.
Time autoProve.
Qed.
