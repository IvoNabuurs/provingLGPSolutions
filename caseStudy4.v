...
[[1, "White", "Spain", "400m", "2 medals", "5'11""", "GlideSpeed"],
 [2, "Green", "Argentine", "4x100m", "6 medals", "6'2""", "AquaFlow"],
 [3, "Purple", "Mexico", "200m", "8 medals", "6'5""", "WaveStrong"],
 [4, "Orange", "Pakistan", "50m", "4 medals", "6'4""", "HydroSwift"],
 [5, "Black", "Australia", "1500m", "5 medals", "6'1""", "FinPower"]].
...
(* Case study 4. *)
Theorem caseStudy4 : 
preconditions /\ comparison "Purple" "4 medals" 0 before /\ directLink "4x100m" "6 medals" /\ 
comparison "Orange" "6'5""" 0 (afterFixed 1) /\ comparison "Green" "FinPower" 0 before /\ 
directLink "Black" "Australia" /\ directLink "400m" "GlideSpeed" /\ 
comparison "WaveStrong" "4x100m" 0 after /\ comparison "WaveStrong" "Pakistan" 0 before /\ 
directLink "Mexico" "6'5""" /\ directLink "5 medals" "FinPower" /\ directLink "Green" "4x100m" /\ 
comparison "WaveStrong" "6'4""" 0 (distance 1) /\ comparison "Green" "6'4""" 0 before /\ 
comparison "White" "Argentine" 0 before /\ either "6'1""" 1 5 /\ 
directLink "5 medals" "6'1""" /\ comparison "8 medals" "Orange" 0 (distance 1) /\ 
directLink "6'2""" "AquaFlow" /\ directLink "Pakistan" "HydroSwift" /\ 
comparison "50m" "WaveStrong" 0 after /\ comparison "50m" "1500m" 0 before. 
Proof.
Time autoProve.
Qed.
